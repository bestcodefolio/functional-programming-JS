...
const Pizza = function(ingredients) {
    ...
    const calculateCostOfIngredients = () =>{
        return this.ingredients.reduce((result, current) => +result + current);
    }
...
CircledPizza.prototype = Object.create(Pizza.prototype);

CircledPizza.prototype.calculatePrice = () => {
    Pizza.prototype.calculatePrice.apply(this);
}
...
SquaredPizza.prototype = Object.create(Pizza.prototype);
SquaredPizza.prototype.calculatePrice = () => {
    Pizza.prototype.calculatePrice.apply(this);
}
